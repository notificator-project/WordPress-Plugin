...
- registers a custom event for immediate Discover visibility;
- registers a matching ready-made template;
- supplies named event arguments for conditions and placeholders;
- provides a nonce-protected WordPress admin page for triggering the event.
...
7. Confirm **Dashboard delivered** under **Notificator → Activity**.
